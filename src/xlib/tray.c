...
extern uint8_t _binary_icons_utoxx_128x128_png_start;
extern size_t  _binary_icons_utoxx_128x128_png_size;
...
static void draw_tray_icon(void) {
    ...
    uint8_t *icon_data = (uint8_t *)&_binary_icons_utoxx_128x128_png_start;
    size_t   icon_size = (size_t)&_binary_icons_utoxx_128x128_png_size;
